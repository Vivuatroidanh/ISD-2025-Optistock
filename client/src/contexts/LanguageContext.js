...
const translations = {
  en: {
    ...
    warehouseReportGenerator: "Warehouse Report Generator",

    exportExcel: "Export Excel",
    exportPDF: "Export PDF",
    errorNotFound: "No products found in the selected date range",
    editField: "Edit Fields",
    notice: "This is only a preview. The full report will be displayed when generated",
    productType: "Product Type",
    productionDate: "Production Date",
    previewReport: "Preview Report",
    generateReport: "Generate Report",
    timePeriod: "Time Period (Filter by Inspection Date)",
    notice2: "Changes will only be applied when you click the Apply button",
    reportTitleLength: "Report title length",
    selectedFields: "Selected fields",
    selectDisplayFields: "Select Display Fields",
  ...
  vi: {
    ...
    apply: "Áp dụng",
    dateFilterApplied: "Lọc theo ngày đã được áp dụng thành công",
    exportAs: "Xuất dữ liệu dưới dạng",
    pdfExportSuccess: "Xuất PDF thành công",
    csvExportSuccess: "Xuất CSV thành công",
    pdfExportFailed: "Xuất PDF thất bại",
    csvExportFailed: "Xuất CSV thất bại",
    preparingReport: "Đang chuẩn bị báo cáo...",
    templateWillInclude: "Mẫu sẽ bao gồm {count} trường",
    more: "xem thêm",
    ...
    shelfNumber: "Số kệ",
    binNumber: "Số ô",
    storageConditions: "Điều kiện lưu trữ",
    ...
    exportPDF: "Xuất PDF",
    errorNotFound: "Không tìm thấy sản phẩm nào trong khoảng ngày đã chọn",
    editField: "Chỉnh sửa trường dữ liệu",
    notice: "Đây chỉ là bản xem trước. Báo cáo đầy đủ sẽ được hiển thị khi được tạo",
    productType: "Loại sản phẩm",
    productionDate: "Ngày sản xuất",
    previewReport: "Xem trước báo cáo",
    generateReport: "Tạo báo cáo",

    timePeriod: "Khoảng thời gian (Lọc theo ngày kiểm tra)",
    notice2: "Các thay đổi chỉ được áp dụng khi bạn nhấn nút Áp dụng",
    warehouseReportGenerator: "Trình tạo báo cáo kho",
    reportTitleLength: "Độ dài tiêu đề báo cáo",
    selectedFields: "Các trường đã chọn",
    selectDisplayFields: "Chọn trường hiển thị",
    recentlyUsed: "Được sử dụng gần đây",
    basicInformation: "Thông tin cơ bản",
    selectAll: "Chọn tất cả",
    deSelect: "Bỏ chọn",
    timeInformation: "Thông tin thời gian",
    fromDate: "Từ",
    toDate: "Đến",
